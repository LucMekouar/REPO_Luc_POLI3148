...
```{r}
Countries_and_years_clean <- read_csv("/Users/lucmekouar/Desktop/POLI 3148/
REPO_Luc_POLI3148/week 5__data wrangling.2 & data visualization.1/HW/Countries_
and_years_clean.csv") |>
  view()
...
educational_quality |>
  ...
  arrange(Year) |>
  group_by(Country) |>
  summarise(index_2_chg_edu_qual = last(`Education 15+`) - 
...
link to github r markdown file: \<<https://github.com/LucMekouar/REPO_Luc_> POLI3148/blob/main/week%205\_\_data%20wrangling.2%20%26%20data%20visualization.1 /HW/2.0Lec4-5%20In-Class%20Exercise.Rmd\>
